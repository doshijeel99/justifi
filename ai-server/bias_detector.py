...
class BiasDetector:
    ...
    def __init__(self, api_key=None):
        ...
        if not self.api_key:
            raise ValueError("GROQ_API_KEY not found in environment or provided as parameter")
    ...
    async def _call_fastrouter_api(self, prompt: str) -> str:
        ...
        try:
            ...
            raise Exception(f"Error calling FastRouter API: {str(e)}")
