...
export default function DocumentSearch() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8">
      <Card className="mb-8">
        <CardHeader>
          <CardTitle className="text-2xl font-bold">{dict?.legaldocs?.title}</CardTitle>
          <CardDescription>
            {dict?.legaldocs?.desc}
          </CardDescription>
        </CardHeader>
        <CardContent>
          ...
          >
            <div className="w-full md:flex-grow">
              <Input
                type="text"
                placeholder={dict?.legaldocs?.textbox}
                value={searchQuery}
        ...
        <Card className="bg-gray-50">
          <CardContent className="p-12 text-center">
            ...
            <p className="text-gray-500">
              {dict?.legaldocs?.desc1}
            </p>
            <p className="text-gray-400 text-sm mt-2">
            {dict?.legaldocs?.desc2}
            </p>
          </CardContent>
        </Card>
      )}
